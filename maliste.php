...
<div class="body">
    <div class="container ">
        ...
        <div class='text-center'>
           ...
           echo '<a href="index.php">Les articles</a>';
            echo "<h3 class='mt-3 mb-3'>Les articles de ma liste</h3>";
            include('connexionBDD.php');
            $sql = "SELECT * FROM `liste` WHERE `user` = :user";
            ...
            if (!empty($articlesList)) {
                foreach ($articlesList as $articleL) {
                $sql = "SELECT * FROM `article` WHERE `id` = :id";
                $query = $db->prepare($sql);
                $query->bindValue(':id', $articleL['article'], PDO::PARAM_STR);
                $query->execute();
